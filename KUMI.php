...
class KUMI
{
	...
	public function getDatasArray():array
	{
		return array(
			...
			'foreign_identifier2'            => $this->foreign_identifier2,
			'boxes2'                         => $this->boxes2,
			'weight2'                        => $this->weight2,
			'cost_declaration2'              => $this->cost_declaration2,
			'cost_declaration_currency2'     => $this->cost_declaration_currency2,
			'comment2'                       => $this->comment2,
			'payoutmode'                     => $this->payoutmode,
			'banckaaccount_id'               => $this->banckaaccount_id,
			'customer_foreign_identifier'    => $this->customer_foreign_identifier,
			'extra_services'                 => $this->extra_services,
			'package_status'                 => $this->package_status,
			'package_condition'              => $this->package_condition
		);
	}
	/**
	 * @return string
